...
const AwardItem = ({ award }: { award: AwardType }) => {
  return (
    <li className="flex flex-col gap-0.5 my-4 leading-none [&:nth-last-child(n+3)]:hidden [&:nth-last-child(n+3)]:md:flex">
      <b className="text-lg text-theme-dark-grey">{award.title}</b>
      <span className="text-md font-medium text-theme-dark-grey mt-0.5">
    ...
    <div className="flex-1">
      ...
      <div className="flex flex-col ">
        <Card className="bg-white/50 shadow-md backdrop-blur-sm border-none gap-4">
          <CardHeader>
            <h3 className="text-theme-dark-grey font-semibold text-lg">
              수상 이력
            </h3>
          </CardHeader>
          <CardContent>
